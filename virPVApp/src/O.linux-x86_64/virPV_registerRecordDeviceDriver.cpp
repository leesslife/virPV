...
/* Generated from ../O.Common/virPV.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_devVirAiSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devVirAiSoft", "devAoSoft", "devAoSoftRaw", "devAoSoftCallback",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devVirAiSoft, pvar_dset_devAoSoft, pvar_dset_devAoSoftRaw,
    pvar_dset_devAoSoftCallback, pvar_dset_devBiSoft,
    pvar_dset_devBiSoftRaw, pvar_dset_devBiSoftCallback,
...
int virPV_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/usr/local/epics/virPV";
...
/* virPV_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"virPV_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    virPV_registerRecordDeviceDriver(*iocshPpdbbase);
}
